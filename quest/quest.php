...
$steps = [
    [
        'id' => 1,
        'image' =>'./img/king1.jpg',
        'question' => '<p>Вы заходите в покои Короля.</p><p> Король:</p><p>- Приветствую тебя, герой! Держава в опасности. Долго объяснять, иди убей дракона. Вот тебе на руки платежное поручение на 1000 золотых! Произведи закупку у единственного поставщика, оприходуй товар, правильно заполни документацию и стремительно отправляйся в бой пока не поздно!</p><p> Ваш ответ:</p>',
        'answers' => [
            [
                'text' => 'Согласен',
                'function' => 'next',
